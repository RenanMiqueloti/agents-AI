...
- **[ADR-0004](docs/adr/0004-faiss-vs-qdrant.md): FAISS em vez de Qdrant** — embeddable é suficiente para corpus estático; Qdrant fica em [`rag-chatbot`](https://github.com/RenanMiqueloti/rag-chatbot) onde o retrieval híbrido e o re-ranking justificam.
