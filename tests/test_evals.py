...
def test_build_agents_map_returns_seven_entries(
    ...
    monkeypatch.setattr(rag_mod, "_make_embeddings", lambda model=None: FakeEmbeddings())
...
def test_run_evals_writes_results_file(
    ...
    # Patch _make_embeddings — build_agents_map instancia rag_agent que precisa de embeddings.
    import agents.rag_agent as rag_mod
    from tests.fakes import FakeEmbeddings as _FakeEmb

    monkeypatch.setattr(rag_mod, "_make_embeddings", lambda model=None: _FakeEmb())
